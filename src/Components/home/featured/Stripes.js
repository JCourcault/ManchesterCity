...
class Stripes extends Component {
  state = {
    stripes: [
      ...
      { background: "white", left: 360, rotate: 25, top: -397, delay: 200 },
      { background: "#98c5e9", left: 600, rotate: 25, top: -498, delay: 400 }
    ]
  };

  showStripes = () => {
    return this.state.stripes.map((stripe, key) => (
      <Animate
        key={key}
        show={true}
        start={{ background: "white", opacity: 0, left: 0, rotate: 0, top: 0 }}
        enter={{
